package com.example.whatsappclonet.music.detail
...
import com.example.whatsappclonet.music.Music
import com.example.whatsappclonet.service.MusicPlayerService
...
class MusicDetailActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activiry_music_player)
